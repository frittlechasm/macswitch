...
- Session orchestration: checks permission when a session begins and again immediately before activation, snapshots candidates, filters to current-workspace candidates, renders the overlay, advances selection, and activates or cancels.
