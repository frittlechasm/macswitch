...
- When changing architecture or durable implementation guidance, update the relevant Markdown source under `docs/` and its matching human-readable HTML companion when one exists, such as `docs/architecture.md` and `docs/architecture.html`.
